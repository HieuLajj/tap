...
public class RewardManager : MonoBehaviour
{
    ...
    public void CountCoins()
    {
        ...
        for (int i = 0; i < pileOfCoins.transform.childCount; i++)
        {
            ...
            pileOfCoins.transform.GetChild(i).GetComponent<RectTransform>().DOAnchorPos(new Vector2(coinimage.rectTransform.anchoredPosition.x, coinimage.rectTransform.anchoredPosition.y), 0.8f)
